<?php
  // Скрываем предупреждения об устаревших функциях в PHP 8.3
  error_reporting(E_ALL & ~E_DEPRECATED);

  // Упражнение 2: Установка локали и выбор значений даты
  setlocale(LC_ALL, 'ru_RU.utf8', 'rus_rus', 'russian');
  $day = @strftime('%d');
  $mon = @strftime('%B');
